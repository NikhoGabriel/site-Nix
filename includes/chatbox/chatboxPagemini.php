<?php function chatboxminiPage ()
{
	...
	?>
		<section id="chatbox">
			Activez Javascript pour accéder à la chatbox, ou arrêtez d'utiliser Internet Explorer, essayez plutôti <a href="https://www.mozilla.org/fr/firefox/desktop/">Firefox</a>, <a href="https://www.google.fr/chrome/browser/desktop/">Google Chrome</a> ou <a href="http://www.opera.com/fr">Opera</a>.
		</section>
		...
		<script src="includes/chatbox/chatboxminiReload.js"></script>
	<?php
	}
	else
	{	?>
